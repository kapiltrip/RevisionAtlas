 ...
 * Lecture path: Lessons 39-42 - AXI-Stream FIFO
 * Downloadable source page: Lesson 042
 * Module: axis_fifo
 ...
 *
 * ASSUMPTIONS:
 * - One clock domain carries 8-bit TDATA, 4-bit TKEEP, and TLAST.
 * - Sixteen array entries are declared while the course full threshold is count equal to 15.
 * - The sequential priority structure handles the instructor's write-then-read scenarios.
 *
 * USED / OMITTED / SIMPLIFIED:
 * - TSTRB, TID, TDEST, TUSER, asynchronous clock crossing, and parameterized depth are absent.
 * - Simultaneous push and pop are not independently processed in the priority chain.
 *
 * BEHAVIORAL CONSEQUENCE:
 * - The effective course capacity and pointer/count behavior must be read from the retained threshold logic.
 * - This file is a lecture reproduction, not a drop-in production FIFO.
 */
module axis_fifo
 (
