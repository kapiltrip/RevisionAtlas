...
[Previous: Section 2](Section%2002%20-%20AXI-Stream%20Interface%20Fundamentals.md) | [Course hub](README.md) | [Next: Section 4](Section%2004%20-%20Getting%20Started%20with%20AXI4-Lite.md)
...
![Full-screen AXI-Stream arbiter architecture, input packets, output packet, and interface ports](../images/Day%2002/34-axis-arbiter-p1-overview-fullscreen.jpg)
...
![Full-screen request timing and three-state packet-arbiter flowchart](../images/Day%2002/35-axis-arbiter-p2-25.png)
...
![Full-screen arbiter RTL showing idle selection and the start of state s1](../images/Day%2002/35-axis-arbiter-p2-65.png)
...
![Full-screen arbiter RTL showing the complete s1 and s2 packet-selection branches](../images/Day%2002/35-axis-arbiter-p2-88.png)
...
![Full-screen final arbiter state logic and output assignments](../images/Day%2002/36-axis-arbiter-p3-25.png)
...
![Full-screen arbiter output decoder for data, last, and valid](../images/Day%2002/36-axis-arbiter-p3-65.png)
...
![Full-screen arbiter testbench with reset, randomized data, source valid, source last, and downstream ready](../images/Day%2002/37-verify-axis-arbiter-25.png)
...
![Full-screen Vivado waveform showing source packets, output data, TLAST, state, and registered payload](../images/Day%2002/37-verify-axis-arbiter-65.png)
...
![Full-screen FIFO module ports, payload memories, pointers, flags, and occupancy counter](../images/Day%2002/39-axis-fifo-p1-20.png)
...
![Full-screen FIFO timing diagram showing a packet buffered before the consumer becomes ready](../images/Day%2002/39-axis-fifo-p1-55.png)
...
![Full-screen FIFO arrays, pointers, count, full detection, and empty detection](../images/Day%2002/40-axis-fifo-p2-20.png)
...
![Full-screen FIFO reset block initializing pointers, count, valid, keep, last, and data](../images/Day%2002/40-axis-fifo-p2-55.png)
...
![Full-screen FIFO write and read branches updating memory, pointers, count, and output valid](../images/Day%2002/40-axis-fifo-p2-85.png)
...
![Full-screen FIFO testbench signals and DUT instantiation](../images/Day%2002/41-axis-fifo-p3-course-labeled-p2-20.png)
...
![Full-screen FIFO waveform filling to full, holding occupancy, and draining to empty](../images/Day%2002/41-axis-fifo-p3-course-labeled-p2-55.png)
...
![Full-screen alternate FIFO interface using wire outputs with the same beat memories and pointers](../images/Day%2002/43-axis-fifo-alternate-20.png)
...
![Full-screen alternate FIFO sequential memory update and pointer/count logic](../images/Day%2002/43-axis-fifo-alternate-55.png)
...
![Full-screen alternate FIFO waveform showing fill, full, drain, pointers, and count](../images/Day%2002/43-axis-fifo-alternate-85.png)
