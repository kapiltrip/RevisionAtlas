...
[Back to AHB](../01%20AHB/README.md) | [Back to AMBA](../README.md)
...
([Arm IHI 0033C, §§3.1 and 3.7](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
([Arm IHI 0033C, §§2.2-2.5 and 3.1](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
Notebook pages 1-4 establish the bus, bridge, component roles, and interface.
Pages 5-9 introduce `HTRANS`, phase overlap, reads, writes, waits, responses,
and `HSIZE`. Pages 10-14 develop burst addresses, boundaries, `HBURST`, BUSY,
and IDLE behavior. Pages 15-18 turn those rules into an FSM, module ports, and
separate address/data-phase registers. The iPad pages revisit the same timing
and burst cases beside the relevant notebook sections below.

## 1. Bus purpose, components, and ownership

### Lecture frame: the manager starts the transfer

![Lecture frame showing the AHB manager role](images/AHB/lecture/ahb-manager-role.png)
...
([Arm IHI 0033C, §§1.1.1-1.1.3 and 4.3](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Original handwritten AHB introduction](images/AHB/pages/01-amba-ahb-introduction.jpg)
...
([Arm IHI 0033C, §1.1](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Original handwritten SoC and bridge page](images/AHB/pages/02-soc-bridge-and-transactions.jpg)
...
![Original handwritten manager and subordinate page](images/AHB/pages/03-manager-subordinate-and-interconnect.jpg)
...
([Arm IHI 0033C, §§4.2-4.3](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Original handwritten manager interface signals](images/AHB/pages/04-manager-interface-signals.jpg)
...
([Arm IHI 0033C, §§2.3-2.5](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
([Arm IHI 0033C, §§2.4 and 4.2](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

## 2. Basic transfer phases

### Lecture frame: read without wait states

![Lecture waveform for an AHB read without wait states](images/AHB/lecture/ahb-read-no-wait.png)
...
([Arm IHI 0033C, §3.1](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### Original notebook page 5: `HTRANS` makes a transfer valid

![Original handwritten HTRANS and single-transfer page](images/AHB/pages/05-htrans-encodings-and-single-transfer.jpg)
...
advance ([Arm IHI 0033C, §3.2](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
the data bus” ([Arm IHI 0033C, §3.2](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Original handwritten address and data phases](images/AHB/pages/06-address-and-data-phases.jpg)
...
([Arm IHI 0033C, §§3.1 and 6.1](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### Original notebook page 7: read transfer without a wait

![Original handwritten read-transfer waveform](images/AHB/pages/07-read-transfer-no-wait.jpg)
...
([Arm IHI 0033C, §§3.1 and 6.1.2](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Lecture waveform for an AHB write without wait states](images/AHB/lecture/ahb-write-no-wait.png)
...
![Original handwritten HREADY and HRESP page](images/AHB/pages/08-write-transfer-hready-and-hresp.jpg)
...
([Arm IHI 0033C, §§5.1.1-5.1.3](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Lecture waveform for pipelined multiple AHB transfers](images/AHB/lecture/ahb-pipelined-multiple-transfers.png)
...
ordered ([Arm IHI 0033C, §§3.1 and 3.7](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### iPad page 2: annotated multiple-transfer waveform

![Annotated iPad page for multiple transfers](images/AHB/pages/ipad-02-multiple-transfer-annotations.jpg)
...
![Lecture waveform showing AHB transfer types](images/AHB/lecture/ahb-htrans-transfer-types.png)
...
![Original handwritten HTRANS and HSIZE page](images/AHB/pages/09-htrans-types-and-address-sequence.jpg)
...
`HADDR[1:0]=2'b00` ([Arm IHI 0033C, §3.4](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
([Arm IHI 0033C, §§3.2 and 3.4](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### iPad page 3: SINGLE versus INCR4

![Annotated iPad page for HTRANS and INCR4](images/AHB/pages/ipad-03-htrans-and-incr4.jpg)
...
([Arm IHI 0033C, §§3.2 and 3.6](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

## 4. Burst length, size, and wrapping

### Lecture frame: an INCR4 word burst

![Lecture waveform for an INCR4 word burst](images/AHB/lecture/ahb-incr4-word-timing.png)
...
([Arm IHI 0033C, §§3.6 and 3.6.3](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Original handwritten burst and size controls](images/AHB/pages/10-hsize-and-packet-addresses.jpg)
...
([Arm IHI 0033C, §§3.2, 3.4, and 3.6](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Original handwritten burst boundary examples](images/AHB/pages/11-burst-address-boundary.jpg)
...
([Arm IHI 0033C, §§3.6 and 4.2](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### Original notebook page 12: `HBURST` and the completion gate

![Original handwritten HBURST and HREADY page](images/AHB/pages/12-hburst-encodings-and-hready.jpg)
...
16-byte wrap region ([Arm IHI 0033C, §3.6](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
([Arm IHI 0033C, §§3.6.1-3.6.2](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Lecture waveform for undefined INCR behavior](images/AHB/lecture/ahb-undefined-incr-mixed-transfers.png)
...
([Arm IHI 0033C, §§3.2 and 3.6.3](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### iPad page 4: WRAP4 word boundary

![Annotated iPad page for WRAP4 boundary](images/AHB/pages/ipad-04-wrap4-boundary.jpg)
...
region
([Arm IHI 0033C, §3.6](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### iPad page 5: wrapping from a non-base start address

![Annotated iPad page for wrap address examples](images/AHB/pages/ipad-05-wrap-address-examples.jpg)
...
([Arm IHI 0033C, §§3.4 and 3.6](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### iPad page 6: WRAP4 and WRAP8 use different regions

![Annotated iPad page comparing wrap boundaries](images/AHB/pages/ipad-06-wrap4-boundary-examples.jpg)
...
![Annotated iPad page for undefined INCR](images/AHB/pages/ipad-07-undefined-incr.jpg)
...
([Arm IHI 0033C, §§3.6.1 and 3.7.1](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### iPad page 8: transfer size is stable within a burst

![Annotated iPad page for mixed transfer sizes](images/AHB/pages/ipad-08-mixed-size-transfer.jpg)
...
![Lecture waveform for an AHB read with two wait states](images/AHB/lecture/ahb-read-two-wait-states.png)
...
![Lecture waveform for an AHB write with one wait state](images/AHB/lecture/ahb-write-one-wait-state.png)
...
([Arm IHI 0033C, §§3.1 and 6.1.1](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### iPad page 1: writing through a wait state

![Annotated iPad page for a write wait state](images/AHB/pages/ipad-01-write-wait-state-annotations.jpg)
...
([Arm IHI 0033C, §§3.1 and 7.1.1](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### Original notebook page 13: waits do not change burst length

![Original handwritten waited-transfer and BUSY page](images/AHB/pages/13-waited-transfer-and-busy.jpg)
...
([Arm IHI 0033C, §§3.1, 3.2, and 3.7](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### Lecture frame: IDLE during a waited transfer

![Lecture waveform for IDLE during an AHB wait](images/AHB/lecture/ahb-idle-during-wait.png)
...
B ([Arm IHI 0033C, §§3.7.1-3.7.2](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Original handwritten INCR, BUSY, and IDLE page](images/AHB/pages/14-incr-busy-and-idle.jpg)
...
([Arm IHI 0033C, §3.7](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Annotated iPad page for subordinate response and IDLE](images/AHB/pages/ipad-09-idle-during-wait.jpg)
...
([Arm IHI 0033C, §§2.3-2.5 and 4.3](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
![Annotated iPad page for BUSY during a wait](images/AHB/pages/ipad-10-busy-during-wait.jpg)
...
![Original handwritten manager FSM](images/AHB/pages/15-manager-fsm.jpg)
...
![Original handwritten SINGLE-transfer exercise](images/AHB/pages/16-single-transfer-setup-exercise.jpg)
...
([Arm IHI 0033C, §§3.1-3.2](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### Original notebook page 17: module ports

![Original handwritten AHB manager module ports](images/AHB/pages/17-manager-module-ports.jpg)
...
([Arm IHI 0033C, §§2.2 and 7.1.2](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).

### Original notebook page 18: data-phase registers

![Original handwritten manager register draft](images/AHB/pages/18-manager-registers.jpg)
...
([Arm IHI 0033C, §§2.2, 3.6, and 6.1](../01%20AHB/sources/ARM-IHI-0033C-AMBA-AHB-Protocol-Specification.pdf)).
...
- [AHB lecture 1 — introduction and bus roles](https://www.youtube.com/watch?v=dxKE1wHvHCg&list=PLqPfWwayuBvNX_IQPBHGJn8YFkvI86lr9)
- [AHB lecture 2 — read/write without waits](https://www.youtube.com/watch?v=3SFTy4on9sc&list=PLqPfWwayuBvNX_IQPBHGJn8YFkvI86lr9)
- [AHB lecture 3 — transfers with waits](https://www.youtube.com/watch?v=-EbEzAacqoQ&list=PLqPfWwayuBvNX_IQPBHGJn8YFkvI86lr9)
- [AHB lecture 4 — multiple pipelined transfers](https://www.youtube.com/watch?v=M4CxmSdoSzA&list=PLqPfWwayuBvNX_IQPBHGJn8YFkvI86lr9)
- [AHB lecture 5 — `HTRANS` and bursts](https://www.youtube.com/watch?v=v2EcFDnWIrw&list=PLqPfWwayuBvNX_IQPBHGJn8YFkvI86lr9)
- [AHB lectures 6-7 — wrapping bursts](https://www.youtube.com/watch?v=1or91qL6bds&list=PLqPfWwayuBvNX_IQPBHGJn8YFkvI86lr9)
- [AHB lecture 8 — transfer types during waits](https://www.youtube.com/watch?v=39QRExXRBSs&list=PLqPfWwayuBvNX_IQPBHGJn8YFkvI86lr9)
- [AHB lectures 9-12 — manager FSM and RTL](https://www.youtube.com/watch?v=DmYdSlO2MiE&list=PLqPfWwayuBvNX_IQPBHGJn8YFkvI86lr9)
