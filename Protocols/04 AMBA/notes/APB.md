...
[Back to APB](../02%20APB/README.md) | [Back to AMBA](../README.md)
...
protocol
([Arm IHI 0024E, §§2.1, 3.1, and 4.1](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).

## Source sequence

Notebook pages 19-20 introduce the AHB-to-APB bridge and core signals. Pages
21-24 develop SETUP/ACCESS timing, wait-state stability, reads, `PSLVERR`, and
the controller FSM. The separate iPad page revisits the waited-write case
beside the relevant section below.

## 1. Why APB exists

### Lecture frame: a bridge reaches simple peripherals

![Lecture frame showing the APB bridge role](images/APB/lecture/apb-bridge-role.png)
...
![Original handwritten APB overview and bridge page](images/APB/pages/01-apb-overview-and-bridge.jpg)
...
([Arm IHI 0024E, §1.1](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).
...
![Original handwritten APB interface signals](images/APB/pages/02-apb-interface-signals.jpg)
...
([Arm IHI 0024E, Chapter 3](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).
...
([Arm IHI 0024E, §§2.1.1-2.1.2](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).
...
![Lecture waveform for an APB write without wait states](images/APB/lecture/apb-write-no-wait.png)
...
sequence
([Arm IHI 0024E, §3.1.1](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).

### Original notebook page 21: SETUP then ACCESS

![Original handwritten APB transfer phases](images/APB/pages/03-apb-transfer-phases.jpg)
...
([Arm IHI 0024E, §§3.1.1 and 4.1](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).

## 3. Wait states mean “hold ACCESS”

### Lecture frame: write with wait states

![Lecture waveform for an APB write with wait states](images/APB/lecture/apb-write-wait-states.png)
...
([Arm IHI 0024E, §3.1.2](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).

### Original notebook page 22: stability through waits

![Original handwritten APB wait-state page](images/APB/pages/04-apb-wait-states-and-stability.jpg)
...
![Annotated iPad page for an APB write wait state](images/APB/pages/ipad-01-apb-write-wait-state.jpg)
...
([Arm IHI 0024E, §§3.1.2 and 3.4](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).

## 4. Read timing

### Lecture frame: read with no wait state

![Lecture waveform for an APB read without wait states](images/APB/lecture/apb-read-no-wait.png)
...
([Arm IHI 0024E, §3.3.1](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).
...
![Lecture waveform for an APB read with wait states](images/APB/lecture/apb-read-wait-states.png)
...
([Arm IHI 0024E, §3.3.2](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).
...
![Original handwritten APB read, wait, and error page](images/APB/pages/05-apb-read-wait-and-errors.jpg)
...
([Arm IHI 0024E, §§3.3 and 3.4](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).
...
![Lecture waveform for an APB write error](images/APB/lecture/apb-write-error.png)
...
([Arm IHI 0024E, §§3.4 and 3.4.1](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).

### Lecture frame: read error

![Lecture waveform for an APB read error](images/APB/lecture/apb-read-error.png)
...
completion ([Arm IHI 0024E, §3.4](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).
...
([Arm IHI 0024E, §3.4.3](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).

## 6. Controller state machine

### Lecture frame: IDLE, SETUP, and ACCESS

![Lecture state diagram for APB operation](images/APB/lecture/apb-operating-states.png)
...
style ([Arm IHI 0024E, §4.1](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).

### Original notebook page 24: waited write and FSM draft

![Original handwritten APB write wait-state and FSM page](images/APB/pages/06-apb-write-wait-and-fsm.jpg)
...
([Arm IHI 0024E, §4.1](../02%20APB/sources/ARM-IHI-0024E-AMBA-APB-Protocol-Specification.pdf)).
...
- [APB lecture 1 — purpose and interface](https://www.youtube.com/watch?v=MIjXS7ap0Hk&list=PLqPfWwayuBvPpjwnJsJ7qSQAXh7NQFMzO)
- [APB lecture 2 — read/write transfers and waits](https://www.youtube.com/watch?v=MThzJkZeVDI&list=PLqPfWwayuBvPpjwnJsJ7qSQAXh7NQFMzO)
- [APB lecture 3 — `PSLVERR`](https://www.youtube.com/watch?v=q3jmUDlo94I&list=PLqPfWwayuBvPpjwnJsJ7qSQAXh7NQFMzO)
- [APB lecture 4 — state machine and RTL](https://www.youtube.com/watch?v=WFYG1ST5pko&list=PLqPfWwayuBvPpjwnJsJ7qSQAXh7NQFMzO&index=4)
